from plots import Window, Cell, Point
import random
import time

class Maze():
    def __init__(self, x1, y1, num_rows, num_cols, cell_size_x, cell_size_y, win, seed=42):
        random.seed(seed)
        self._cells = []
        self._x1 = x1
        self._y1 = y1
    ...
    def _break_walls_r(self, i, j):
        ...
        while True:
            ...
            direction_index = random.randrange(len(ij_s))
            next_index = ij_s[direction_index]
